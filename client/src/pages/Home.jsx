...
export default function Home() {
  ...
  return (
    <div className='bg-grid-slate bg-radial-fade'>
      <div className='flex flex-col gap-6 p-10  px-3 max-w-6xl mx-auto '>
        <h1 className='text-3xl font-extrabold tracking-tight lg:text-6xl pt-10'>Welcome to my Blog</h1>
      ...
      <div className='max-w-6xl mx-auto p-3 flex flex-col gap-8 py-3'>
        {posts && posts.length > 0 && (
          <div className='flex flex-col gap-6'>
            <h2 className='text-2xl font-bold tracking-tight text-center'>Recent Posts</h2>
            ...
            <Link
              to={'/search'}
              className='text-lg text-brand-600 hover:underline text-center'
            >
              View all posts
            </Link>
          </div>

...
export default function Projects() {
  return (
    <div className='min-h-screen max-w-4xl mx-auto flex justify-center gap-8 items-center flex-col p-6 bg-grid-slate bg-radial-fade'>
      <h1 className='text-4xl font-extrabold tracking-tight text-center'>Explore Our Projects</h1>
      <p className='text-sm sm:text-base text-slate-600 dark:text-slate-300 text-center max-w-3xl'>
      ...
      <div className='w-full flex flex-col gap-6'>
        <section className='bg-white/70 dark:bg-slate-900/40 p-6 rounded-xl shadow-card border border-slate-200/60 dark:border-white/10'>
